...
docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t http://ec2-43-205-13-155.ap-south-1.compute.amazonaws.com:$PORT/v3/api-docs -f openapi -c zap_rules -r zap_report.html
